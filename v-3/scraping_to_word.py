...
def create_word_from_scratch(sections_data, output_file="estudio_diario.docx"):
    """
...
def json_to_word(json_file_path: str,
    ...
    """
    # Ajustar nombre según fecha (formato seguro para Windows)
    if date_obj:
